<template>
  ...
  >
    <Header></Header>
    <Hero :hero-images="heroImages"></Hero>
  </section>
  <section>
    <Mission :about-image="aboutImage"></Mission>

    <PetList :pet-images="petImages"></PetList>

    <Sponsors :sponsor-details="sponsorDetails"></Sponsors>
  </section>
  <section
...
const aboutImage = [
  {
    ...
    desc: "You need to see some pets in Raff Adopt. We have the friend that's you need to have. We also have the equipment you need to take care of it.",
    communityHeader: "Raff Adopt COMMUNITY",
    communityTitle: "Connect with Raff Adopt across the country",
    communityDesc:
      "Raff Adopt Community Uniting hearts, fostering bonds. Pet adoption advocates, diverse family, shared joy. Rescuing lives, creating smiles, caring network. Join us, embrace the joy of adoption!",
    countOne: 500,
