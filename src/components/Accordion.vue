...
const accordionItems = ref([
  {
    ...
    content:
      "Create a user account in Raff Adopt. Once finished, you can choose which animal you want to adopt in the adopt list.",
    show: false,
  },
  {
  ...
  {
    title: "Does Raff Adopt sell animals other than cats and dogs?",
    content: "No, Raff Adopt does not sell animals other than cats and dogs.",
    show: false,
  },
  {
    title: "Is there a special animal clinic at Adopt Me?",
    content:
      "Yes, there is a special clinic to handle the care of cats and dogs at Raff Adopt.",
    show: false,
  },
]);
